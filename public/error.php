...
switch(getenv("REDIRECT_STATUS"))
{
	...
	$redirect_to = $server_url . "medico" . $end_of_path;
	break;
	...
	$redirect_to = $server_url . "medico";
	break;
	
	# "500 - Internal Server Error"
	case 500:
	$error_code = "500 - Internal Server Error";
	$explanation = "The requested resource '" . $page_redirected_from . "' The server encountered an unexpected condition which prevented it from fulfilling the request..";
	$redirect_to = $server_url . "medico";
	break;
}
?>
...
<p>The <a href="http://localhost/medico">URL</a> you requested was not found. <?PHP echo($explanation); ?></p>
