...
<div class="main-container">
    ...
    <div class="aside">
        ...
        <ul class="nav">
            <li><a href="#" class="active" id="enlace-inicio"><i class="fa fa-home"></i> Home</a></li>
            <li><a href="#" id="enlace-about"><i class="fa fa-user"></i> About</a></li>
            <li><a href="#" id="enlace-services"><i class="fa fa-list"></i>Services</a></li>
                    ...
                    <div class="portfolio-item padd-15">
                        <div class="portfolio-item-inner shadow-dark">
                            <div class="portfolio-img">
                                ...
                                <div class="centrado">
                                    <p>
                                    <h2>{{$portaf->title}}</h2> {{$portaf->description}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row formulario">
                    ...
                    <div class="col-6 mapa">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d8263.138958215106!2d-76.00461300229097!3d-9.297275307784231!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x91a641893b93a2c9%3A0xc1cdbb44b0668e30!2sTingo%20Mar%C3%ADa%2010131!5e0!3m2!1ses-419!2spe!4v1644384466830!5m2!1ses-419!2spe"
...
<a href="https://api.whatsapp.com/send?phone=+{{$about->phone}}&text=Hola%21%20Quisiera%20m%C3%A1s%20informaci%C3%B3n%20sobre%20un%20sitio%20web."
    class="float" target="_blank" title="¿Podemos ayudarlo?">
    <i class='bx bxl-whatsapp my-float'></i>
</a>
<a href="https://www.messenger.com/t/jonel.sacramento.96/" target="_blank" class="messenger"
    title="Contactame por Messenger">
