            ...
            <div class="page-body page-body-light pt-3">
                ...
                <div class="card mb-4 card-header-actions">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form method="POST" action="{{ route('portafolio.update', $portafolio) }}"  role="form" enctype="multipart/form-data">
                        {{ method_field('PATCH') }}
                            @csrf
                            ...
                            <div class="row gx-3 mb-3">
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" type="text" name="title" placeholder="Enter title" value="{{$portafolio->title}}"  required />
                                    @error('title')
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control"  type="text" name="description" placeholder="Enter description" value="{{$portafolio->description}}" required />
                                    @error('description')
                                        <small class="text-danger" autofocus> {{$message}}</small>
                                    @enderror
                                </div>
                                <div class="col-md-12">
                                    ...
                                    <img src="../images/portfolio/{{$portafolio->photo}}" width="100" heigth="50">
