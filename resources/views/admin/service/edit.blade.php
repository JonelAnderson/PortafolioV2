        ...
        <main>
			...
			<div class="page-body page-body-light pt-3">
				...
				<div class="card mb-4 card-header-actions">
					<div class="card-header">Actualizar Servicio</div>
					<div class="card-body">
						...
						@endif
						<form method="POST" action="{{ route('service.update', $service) }}"  role="form" enctype="multipart/form-data">
						{{ method_field('PATCH') }}
							@csrf
							...
							<div class="row gx-3 mb-3">
								...
								<div class="col-md-12">
									...
									<input class="form-control"  type="text" name="title" placeholder="Enter title" value="{{$service->title}}" required />
									@error('title')
								...
								<div class="col-md-12">
									...
									<input class="form-control" type="text" name="image_service" placeholder="Enter icon name" value="{{$service->image_service}}"  required />
									@error('image_service')
										<small class="text-danger" autofocus> {{$message}}</small>
									@enderror
								</div>
